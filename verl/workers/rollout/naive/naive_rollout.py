...
from verl.models.transformers.qwen_vl_utils import append_response_position_ids
...
class NaiveRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto) -> DataProto:
        ...
        for _ in range(self.config.response_length):
            ...
            position_ids = append_response_position_ids(position_ids, response_length=1, batch_size=idx.size(0))
