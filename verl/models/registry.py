...
_MODELS_SUPPORT_RMPAD = {'llama', 'mistral', 'gemma', 'qwen2', 'qwen2_vl', 'qwen2_5_vl', 'qwen3', 'qwen3_vl'}
...
def check_model_support_rmpad(model_type: str):
    ...
    if model_type == "qwen3_vl":
        print("Qwen3-VL uses the native transformers multimodal position-id path; "
              "keep ulysses_sequence_parallel_size=1 for now.")
