...
class TTVFMForConditionalGeneration(Qwen2VLPreTrainedModel, GenerationMixin):
    ...
    def __init__(self, config):
        ...
        # self.model = Qwen2ForCausalLM._from_config(config)
        self.model = Qwen2Model(config)
        self._no_split_modules = ["Qwen2DecoderLayer", "Qwen2VLVisionBlock"]
        ...
        if position_ids is None and (attention_mask is None or attention_mask.ndim == 2):
            ...
            if (cache_position is not None and cache_position[0] == 0) or self.rope_deltas is None:
                position_ids, rope_deltas = self.get_rope_index(
                    input_ids, image_grid_thw=None, video_grid_thw=None, attention_mask=attention_mask
                )
...
__all__ = ["TTVFMForConditionalGeneration"]
